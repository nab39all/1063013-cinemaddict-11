const createDetailsTopMarkup = (film) => {
  const {poster, age, title, originalTitle, raiting, director, writers, actors
    , release, duration, country, genres, description, isInWatchList, isWatched, isFavorite} = film;
...
const createCommentMarkup = (film) => {
  const {smile, commentText, commentAuthor, commentDate} = film.comments;
  return (
...
export const createFilmDetailsPopUpTemplate = (film) => {
  ...
  return (
    `<section class="film-details">
      ...
      ${createDetailsTopMarkup(film)}
        <div class="form-details__bottom-container">
          <section class="film-details__comments-wrap">
            <h3 class="film-details__comments-title">Comments <span class="film-details__comments-count">${commentsCount}</span></h3>

            <ul class="film-details__comments-list">
              ${createCommentMarkup(film)}
            </ul>
